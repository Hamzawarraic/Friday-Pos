<?php
   get_header();
   /*
   * Template Name: Bar,Wine and Liqour
   */
   ?>
...
<section class="section-padding pos-banner left-banner-image banner-wrapper banner-bg-image pt-0" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/pos-banner-bg.png)">
   <div class="container">
      <div class="row g-4 align-items-center">
         <div class="col-lg-5">
            <p class="custom-fontbold mb-3 text-uppercase">Beer, wine, & liquor</p>
            <h2>The POS System Crafted For Breweries, Wine Shops, And Liquor Stores</h2>
            <h6 class="my-3 grey-text-clr">Running a multi-location beverage business takes expert craftsmanship. That’s why beer, wine, and liquor retailers lean on the all-in-one POS system from Square to handle everything else.</h6>
            <a href="/contact-us/" class="tv-btn tv-btn-primary my-4 ">Get a Demo</a>
         </div>
         <div class="col-lg-7">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/bar-page-banner.png" alt="Pos Banner Image" />
         </div>
      </div>
   </div>
</section>
            ...
            <div class="service-card" >
               <div class="service-card-header">
                  <div class="icon-wrapper blue">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/wine-glass.svg" alt=" Image">
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Wine shops</h6>
                     <p class="grey-text-clr line-clamp3">Perfect every pour while our wine store POS takes on purchase orders, inventory management, vendors, and more.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="service-card" >
               <div class="service-card-header">
                  <div class="icon-wrapper yellow">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/breweries.svg" alt=" Image">
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Breweries</h6>
                     <p class="grey-text-clr line-clamp3">The easy-to-use brewery POS is made to manage every moving part, from keeping kegs full to running your local beer fest.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="service-card" >
               <div class="service-card-header">
                  <div class="icon-wrapper purple">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/liqour-icon.svg" alt=" Image">
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Liquor stores</h6>
                     <p class="grey-text-clr line-clamp3">Raise the bar on your customer experience with a liquor store POS system that speeds up checkout, rewards customers, and offers many ways to buy. </p>
                  </div>
               </div>
            </div>
         </div>
...
<section class="section-padding image-wrapper-section">
   <div class="container">
      <div class="row">
         <div class="col-12">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/bar-station.jpg" alt="Multi Team Dinner Image" />
         </div>
         <div class="col-12">
...
<section class="section-padding custom-padding-bottom-40">
   <div class="container">
      <div class="text-center">
         <h2 class="mb-3 custom-container-large">Serve Up More Bottles
And Keep Shelves Stocked.</h2>
      </div>
         ...
         <div class="col-md-6">
            <div class="p-5">
               ...
               <div class="mb-4 pt-4 d-flex align-items-center">
                  ...
                  <p class=" m-0 ms-3">Maintain accurate inventory across bottles, cases, and kegs.</p>
               </div>
               <div class="mb-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">Know what’s selling out and which brands and vendors perform best.</p>
               </div>
               <div class="mb-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">Automatically create purchase orders when stock is running low.</p>
               </div>
            </div>
         </div>
         ...
         <div class="col-md-6">
            <div class="p-5">
               ...
               <div class="mb-4 pt-4 d-flex align-items-center">
                  ...
                  <p class=" m-0 ms-3">Know what they like by tracking preferences and purchases with every card swipe.</p>
               </div>
               <div class="mb-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">Start a membership program and charge monthly fees with a few taps.</p>
               </div>
               <div class="mb-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">Create automatic discounts for any products or categories you choose.</p>
               </div>
            </div>
         </div>
         <div class="col-md-6 text-center">
...
<section class="section-padding custom-padding-large" style="background:#F4F6F7">
   <div class="container">
      <div class="text-center px-sm-5">
         <h2 class="mb-3">Pair Your POS With 
      ...
      <div class="row g-4 mt-md-4 mt-2 justify-content-center">
         <div class="col-md-6">
            <div class="service-card">
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Square Online </h6>
                     <p class="grey-text-clr">Easily build a professional website to sell your apparel and accessories, and seamlessly integrate your inventory.</p>
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="service-card">
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Square Payroll</h6>
         ...
         <div class="col-md-6">
            <div class="service-card">
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Square Loyalty</h6>
