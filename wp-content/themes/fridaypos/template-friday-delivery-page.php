<?php
   get_header();
   /*
   * Template Name: Friday Delivery Services
   */
   ?>
...
<section class="section-padding pos-banner left-banner-image banner-wrapper banner-bg-image pt-0" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/pos-banner-bg.png)">
   <div class="container">
      <div class="row g-4 align-items-center">
         <div class="col-lg-5">
            <p class="custom-fontbold mb-3 text-uppercase">DELIVERY SERVICES</p>
            <h2>Friday Delivery Services™</h2>
            <h6 class="my-3 custom-fontsemibold grey-text-clr">Friday Delivery Services™ enables restaurants to dispatch local drivers through an on-demand network for efficient delivery fulfillment.</h6>
            <div class="d-flex align-items-start flex-column">
               <a href="/contact-us/" class="tv-btn tv-btn-primary my-4 ">Already A Customer? Add Services</a>
         ...
         <div class="col-lg-7">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/delivery-services-banner.png" alt="Delivery Banner Image" />
         </div>
      </div>
   </div>
</section>
<!-- Banner Section Html End -->
<!-- Restaurants Growth Start -->
<section class="section-padding custom-padding-large" style="background:#F4F6F7;">
   <div class="container">
      <div class="text-center">
         <h2 class="mb-3">Restaurants Using Friday Delivery Experienced Over 29% Growth In Sales Compared To Their Peers</h2>
      </div>
            ...
            <div class="service-card" >
               <div class="service-card-header">
                  <div class="icon-wrapper blue">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/delivery-icon.svg" alt=" Image">
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Deliver</h6>
                     <p class="grey-text-clr line-clamp3">Join the Friday food delivery services network of drivers.</p>
                     <div class="d-flex align-items-center justify-content-end">
                        <a href="#delivery-section" class="arrow-down-link">
            ...
            <div class="service-card" >
               <div class="service-card-header">
                  <div class="icon-wrapper yellow">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/contactless-icon.svg" alt=" Image">
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Contactless</h6>
                     <p class="grey-text-clr line-clamp3">Provide your guests with contactless delivery options for a safer dining experience.</p>
                     <div class="d-flex align-items-center justify-content-end">
                        <a href="#order-summary-section" class="arrow-down-link">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/arrow-down.svg" alt=" Image">
                        </a>
                     </div>
                  </div>
            ...
            <div class="service-card" >
               <div class="service-card-header">
                  <div class="icon-wrapper purple">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/unlimited-orders.svg" alt=" Image">
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Same price for unlimited orders</h6>
                     <p class="grey-text-clr line-clamp3">Maintain your margins with no upfront costs. Pay a single flat fee per order.</p>
                     <div class="d-flex align-items-center justify-content-end">
                        <a href="#order-history-section" class="arrow-down-link">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/arrow-down.svg" alt=" Image">
                        </a>
                     </div>
                  </div>
...
<!-- Restaurants Growth End -->
<!-- Delivery Section Start -->
<section class="section-padding custom-padding-large" id="delivery-section" >
   <div class="container">
      <div class="text-center custom-container-large">
         <h2 class="mb-5">Dine Wherever You Want With Friday Food Delivery </h2>
      </div>
      <div class="img-wrapper my-4">
         <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/dine-wherever.jpg" alt=" Image">
      </div>
      <div class="row g-4 mt-md-4 mt-2">
         <div class="col-md-6 col-lg-4">
            <div class="service-card no-background" >
               <div class="service-card-header">
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">No delivery drivers? </h6>
                     <p class="grey-text-clr line-clamp3">No problem. Our network of local drivers is automatically dispatched once an order is placed.</p>
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4">
            <div class="service-card no-background" >
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Real-Time Order Tracking</h6>
                     <p class="grey-text-clr line-clamp3">Orders can be scheduled in advance for guests while getting order status in real-time.</p>
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4">
            <div class="service-card no-background" >
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Delivery for Online </h6>
                     <p class="grey-text-clr line-clamp3">Whether guests order food online or through the Friday TakeOut app, the top delivery app for restaurants, delivery is a convenient option.</p>
                  </div>
               </div>
            </div>
         </div>
...
<!-- Restaurant Food Services  Start -->
<section class="section-padding">
   <div class="container">
      <div class="row g-4 align-items-center custom-padding-top-40 " id="order-summary-section">
         <div class="col-lg-7 text-center">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/order-summary.jpg"  alt="Menu Management  Image" />
         </div>
         <div class="col-lg-5">
            <div class="">
               <div class="mb-4">
                  <h3 class="custom-fontsemibold mb-2">A Restaurant Food Delivery Service with No Commissions or Hidden Fees </h3>
                  <p class="grey-text-clr">The easiest way for new restaurants to sell, manage, and track. And it’s fully customizable.</p>
               </div>
               <div class="mb-4">
                  <h6 class="custom-fontsemibold mb-2">Food Delivery Fees Decrease as Volume Increases </h6>
                  <p class="grey-text-clr">Start for free* and pay a flat fee per order, rather than a percentage of sales.</p>
               </div>
               <div class="mb-4">
                  <h6 class="custom-fontsemibold mb-2">Restaurant Food Delivery Insights to Inform Your Business </h6>
                  <p class="grey-text-clr">Offset Food Delivery Costs in Creative Ways Adjust minimum ticket sizes and pass on some or all of the delivery fee to your guests using Friday Delivery Services.</p>
               </div>
               <div class="mb-4">
                  <h6 class="custom-fontsemibold mb-2">Restaurant Food Delivery Insights to Inform Your Business </h6>
                  <p class="grey-text-clr">Access reporting and analytics that summarize delivery trends in your restaurant. Adapt your operations based on guest behavior.</p>
               </div>
            </div>
         </div>
      </div>
      <div class="row g-4 align-items-center custom-padding-top-40" id="order-history-section">
         <div class="col-lg-5">
            <div class="">
               <div class="mb-4">
                  <h6 class="custom-fontsemibold mb-2">Simply Put, Guests Want Delivery </h6>
                  <p class="grey-text-clr">Online ordering is extremely important for 33% of guests. Delivery offers them a convenient way to enjoy their meals at the comfort of their home.</p>
               </div>
               <div class="mb-4">
                  <h6 class="custom-fontsemibold mb-2">Guests Order Food for Delivery Directly from </h6>
                  <p class="grey-text-clr">You hold control over delivery orders made online or through Friday TakeOut until they reach their final destination. </p>
               </div>
               <div class="mb-4">
                  <h6 class="custom-fontsemibold mb-2">Your Guests, Your Data </h6>
                  <p class="grey-text-clr">Orders are placed, processed, and paid for within your Friday POS, ensuring you maintain ownership and access to your valuable guest data.</p>
               </div>
            </div>
         </div>
         <div class="col-lg-7 text-center">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/order-history.jpg"  alt="Analytics Reporting Image" />
         </div>
      </div>
   </div>
</section>
<!-- Restaurant Food Services  end -->
