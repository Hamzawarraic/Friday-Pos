<?php
   get_header();
   /*
   * Template Name: Homes Goods & Furniture
   */
   ?>
...
<section class="section-padding pos-banner left-banner-image banner-wrapper banner-bg-image pt-0" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/pos-banner-bg.png)">
   <div class="container">
      <div class="row g-4 align-items-center">
         <div class="col-lg-5">
            <p class="custom-fontbold mb-3 text-uppercase">Home good & Furniture</p>
            <h2>The POS System Designed For Home Decor</h2>
            <h6 class="my-3 grey-text-clr">Sell your home goods and furniture in store and online while Square for Retail manages your inventory, invoices, and more.</h6>
            <a href="javascript:void(0)" class="tv-btn tv-btn-primary my-4 ">Get a Demo</a>
         </div>
         <div class="col-lg-7">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/home-goods-banner.png" alt="Pos Banner Image" />
         </div>
      </div>
   </div>
</section>
            ...
            <div class="service-card" >
               ...
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Simple and Clean Setup</h6>
                     <p class="grey-text-clr line-clamp3">Quick business setup. Personalize your experience by syncing inventory and integrating preferred apps for optimal utilization of our POS system.</p>
                  </div>
               </div>
            </div>
         </div>
...
<section class="section-padding image-wrapper-section">
   <div class="container">
      <div class="row">
         <div class="col-12">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/home-decor-main-image.jpg" alt="Multi Team Dinner Image" />
         </div>
         <div class="col-12">
...
<section class="section-padding custom-padding-bottom-40">
   <div class="container">
      <div class="text-center">
         <h2 class="mb-3 custom-container-large">Run Your Home Goods And Furniture
Store Seamlessly</h2>
      </div>
      ...
      <div class="row g-4 align-items-center mt-5 custom-padding-bottom-40" >
         ...
         <div class="col-md-6">
            <div class="p-5">
               <div class="mb-4">
                  <h3 class="custom-fontsemibold mb-2">Manage your inventory. </h3>
               </div>
               <div class="mb-4 pt-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
      ...
      <div class="row g-4 align-items-center mt-5 custom-padding-bottom-40" >
         <div class="col-md-6">
            <div class="p-5">
               <div class="mb-4">
                  <h3 class="custom-fontsemibold mb-2">Show customers you care.</h3>
               </div>
               <div class="mb-4 pt-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">Buy more and pay later with the Afterpay feature</p>
               </div>
               <div class="mb-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">Get your customers hyped with personalized emails and social media campaigns</p>
               </div>
               <div class="mb-4 d-flex align-items-center">
                  <div class="custom-round-wrapper">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/green-check.svg" alt=" Image">
                  </div>
                  <p class=" m-0 ms-3">A digital loyalty program to reward your customers</p>
               </div>
            </div>
         </div>
         <div class="col-md-6 text-center">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sales-by-payment-outer.jpg"  alt="Menu Management  Image" />
         </div>
      </div>
   </div>
</section>
...
<section class="section-padding custom-padding-large" style="background:#F4F6F7">
   <div class="container">
      <div class="text-center px-sm-5">
         <h2 class="mb-3">Consider Our Other Mobile Dining Solutions Included With Your POS Purchase</h2>
      </div>
      <div class="row g-4 mt-md-4 mt-2 justify-content-center">
         ...
         <div class="col-md-6">
            <div class="service-card">
               <div class="service-card-header">
                  <div class="icon-wrapper yellow">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/square-cards.svg" alt="Friday Online Ordering Image" />
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Square Invoices</h6>
                     <p class="grey-text-clr">Send branded invoices and track them from anywhere in real time. We’ll send the auto-reminders, you collect the payments.</p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="service-card">
               <div class="service-card-header">
                  <div class="icon-wrapper light-pink">
                     <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/svg/gift-cards.svg" alt="Friday Go Plus" />
                  </div>
               </div>
               <div class="service-card-body">
                  <div class="service-card-description">
                     <h6 class="line-clamp3 mb-3">Friday Gift Cards</h6>
                     <p class="grey-text-clr">Offer physical and digital gift cards to make up for each of your customer's shopping experience </p>
                  </div>
               </div>
            </div>
         </div>
